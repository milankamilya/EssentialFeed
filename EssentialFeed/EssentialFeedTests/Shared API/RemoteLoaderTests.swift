...
class RemoteLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteLoader, toCompeteWithResult expectedResult: RemoteLoader.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
        ...
        sut.load { receivedResult in
            ...
            case let (.failure(receivedItems as RemoteLoader.Error), .failure(expectedItems as RemoteLoader.Error)):
                XCTAssertEqual(receivedItems, expectedItems)
