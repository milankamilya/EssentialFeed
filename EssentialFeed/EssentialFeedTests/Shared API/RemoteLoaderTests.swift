...
class RemoteLoaderTests: XCTestCase {
    ...
    func test_load_deliversMappedResource() {
        ...
        expect(sut, toCompeteWithResult: .success(resource)) {
    ...
    private func expect(_ sut: RemoteLoader<String>, toCompeteWithResult expectedResult: RemoteLoader<String>.Result, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
