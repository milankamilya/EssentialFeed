...
class ImageCommentsPresenterTests: XCTestCase {
    ...
    func test_map_createsViewModels() {
        ...
        let comments = [
            ...
            ImageComment(id: UUID(), message: "another message", createdAt: now.adding(minutes: -1), username: "another username")
        ]
        
        let viewModel = ImageCommentsPresenter.map(comments)
        XCTAssertEqual(viewModel.comments, [
            ImageCommentViewModel(message: "a message", date: "5 minutes ago",
                                  username: "a username"),
            ImageCommentViewModel(message: "another message", date: "1 minute  ago",
