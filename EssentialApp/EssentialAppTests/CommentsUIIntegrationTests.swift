...
class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsCompletion_renderErrorMessageOnErrorUntilNextReload() {
        let (sut, loader) = makeSUT()
    ...
    private func assertThat(_ sut: ListViewController, isRendering comments: [ImageComment], file: StaticString = #file, line: UInt = #line) {
        XCTAssertEqual(sut.numberOfRenderedImageCommentsView(), comments.count, "Comments count", file: file, line: line)
